...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea, __ref_mov_rm2s_w, inv,//8d:lea,8e__ref_mov_rm2s_w
    ...
    /* 0xe8 - 0xeb*/ call_near, __ref_jmp_near, __ref_jmp_far_imm, __ref_jmp_short,//  e8call_near, e9jmp_near,eb:jmp_short
