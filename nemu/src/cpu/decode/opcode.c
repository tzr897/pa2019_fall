...
instr_func opcode_entry[256] = {
    ...
    /* 0x74 - 0x77*/ __ref_je_short_, __ref_jne_short_, __ref_jna_short_, inv,//74je_short_,75:jne_short_,76:jna_short_
    ...
    /* 0xe8 - 0xeb*/ __ref_call_near, __ref_jmp_near, inv, __ref_jmp_short,//e8call_near, e9jmp_near,eb:jmp_short
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, inv, inv, __ref_jmp_near_indirect, inv, push_rm_v, inv};//000:inc_rm_v,110:push,001:dec_rm_v,100:jmp_near_ind
