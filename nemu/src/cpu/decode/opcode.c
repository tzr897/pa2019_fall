...
instr_func opcode_entry[256] = {
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, __ref_ret_near, __ref_ret_near,//c2:ret_near
    ...
    /* 0xe8 - 0xeb*/ __ref_call_near, jmp_near, inv, jmp_short,//e8call_near, e9jmp_near,eb:jmp_short
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, inv, inv, jmp_near_indirect, inv, push_rm_v, inv};//000:inc_rm_v,110:push,001:dec_rm_v,100:jmp_near_ind
