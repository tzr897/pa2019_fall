...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ mov_zrm162r_l, mov_zrm162r_l, cmps_v, cmps_v,//10.16?//10.17?
    /* 0x04 - 0x07*/ inv, mov_zrm162r_l, inv, inv,//10.16?
    ...
    /* 0x80 - 0x83*/ group_1_b, group_1_v, nemu_trap, cmps_v,//10.16?
    ...
    /* 0xe8 - 0xeb*/ inv, jmp_near, inv, inv,//10.16
    ...
    /* 0xfc - 0xff*/ cld, mov_zrm162r_w, cmps_v, mov_zrm162r_w,//group_5_indirect,//10.16?//10.17?
};
