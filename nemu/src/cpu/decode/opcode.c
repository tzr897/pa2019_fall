...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ inv, inv, inv, inv,//10.1701cmps_v,02cmps_v,03cmps_v
    /* 0x04 - 0x07*/ inv, inv, inv, inv,//10.1704cmps_v,05cmps_v,06cmps_v,07cmps_v
    /* 0x08 - 0x0b*/ inv, inv, inv, inv,//10.1708cmps_v,09sub_i2rm_v,0acmps_v,0bcmps_v
    ...
    /* 0x38 - 0x3b*/ inv, cmp_r2rm_v, inv, inv,//39:cmp_r2rm_v
    ...
    /* 0x50 - 0x53*/ inv, push_r_v, push_r_v, push_r_v,//53 :push_r_v,51:push_r_v,52:push_r_v
    ...
    /* 0x7c - 0x7f*/ inv, inv, jle_short_, jg_short_,//7f:jg_short_,7e:jle_short_
    /* 0x80 - 0x83*/ inv, group_1_v, nemu_trap, group_1_bv,//10.1783group_1_bv
    /* 0x84 - 0x87*/ inv, test_r2rm_v, inv, inv,//85:test_r2rm_v
...
instr_func group_1_v_entry[8] =
    {add_i2rm_v, inv, inv, inv, inv, sub_i2rm_v, inv, inv};//000:add_i2rm_v,101:sub_i2rm_v

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {inv, inv, inv, inv, and_i2rm_bv, sub_i2rm_bv, inv, cmp_i2rm_bv};//111:cmp_i2rm_bv,101:sub_i2rm_v,100:and_i2rm_bv
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, inv, inv, inv, inv, inv, push_rm_v, inv};//000:inc_rm_v,110:push
