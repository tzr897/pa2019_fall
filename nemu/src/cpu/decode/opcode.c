...
instr_func opcode_entry[256] = {
    ...
    /* 0x74 - 0x77*/ __ref_je_short_, __ref_jne_short_, __ref_jna_short_, __ref_ja_short_,//74je_short_,75:jne_short_,76:jna_short_
...
instr_func group_1_b_entry[8] =
    {inv, inv, inv, inv, and_i2rm_b, inv, inv, cmp_i2rm_b};//111:cmp_i2rm_b
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, __ref_call_near_indirect, inv, __ref_jmp_near_indirect, inv, push_rm_v, inv};//000:inc_rm_v,110:push,001:dec_rm_v,100:jmp_near_ind
