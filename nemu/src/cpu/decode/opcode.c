...
instr_func opcode_entry[256] = {
    ...
    /* 0xa8 - 0xab*/ test_i2a_b, inv, inv, inv,//a8:test_i2a_b
...
instr_func group_1_b_entry[8] =
    {inv, inv, inv, inv, inv, inv, inv, __ref_cmp_i2rm_b};//111:cmp_i2rm_b
...
instr_func group_3_v_entry[8] =
    {inv, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, inv, idiv_rm2a_v};//111:idiv_rm2a_v,100:mul_rm2a_v,101:imul_rm2a_v
