...
instr_func opcode_entry[256] = {
    ...
    /* 0x50 - 0x53*/ inv, inv, inv, __ref_push_r_v,//53 :push_r_v
    /* 0x54 - 0x57*/ inv, __ref_push_r_v, inv, inv,//55push_r_v
...
instr_func group_1_bv_entry[8] =
    {inv, inv, inv, inv, inv, sub_i2rm_bv, inv, cmp_i2rm_bv};//111:cmp_i2rm_bv,101:sub_i2rm_v
