...
instr_func opcode_entry[256] = {
    ...
    /* 0x5c - 0x5f*/ inv, pop_r_v, inv, inv,//5d:pop_r_v
...
instr_func group_3_v_entry[8] =
    {inv, inv, not_rm_v, inv, mul_rm2a_v, __ref_imul_rm2a_v, inv, idiv_rm2a_v};//111:idiv_rm2a_v,100:mul_rm2a_v,101:imul_rm_v
