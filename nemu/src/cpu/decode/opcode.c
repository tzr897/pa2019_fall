...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_i2a_b, add_i2a_v, inv, inv,//10.1704cmps_v,05add_i2a_v
    ...
    /* 0x8c - 0x8f*/ inv, lea, mov_rm2s_w, inv,//8d:lea,8e__ref_mov_rm2s_w
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, jmp_far_imm, jmp_short,//  e8call_near, e9jmp_near,eb:jmp_short
    ...
    /* 0xf8 - 0xfb*/ clc, inv, __ref_cli, __ref_sti,//10.17fbcmps_v,facmps_V,f9cmps_v
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, inv, sbb_i2rm_bv, and_i2rm_bv, sub_i2rm_bv, inv, cmp_i2rm_bv};//111:cmp_i2rm_bv,101:sub_i2rm_v,100:and_i2rm_bv,000:add_i2rm_bv
