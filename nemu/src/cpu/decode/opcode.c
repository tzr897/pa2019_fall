...
instr_func group_1_b_entry[8] =
    {inv, inv, inv, inv, __ref_and_i2rm_b, inv, inv, __ref_cmp_i2rm_b};//111:cmp_i2rm_b

/* 0x81 */
instr_func group_1_v_entry[8] =
    {__ref_add_i2rm_v, inv, inv, inv, __ref_and_i2rm_v, sub_i2rm_v, inv, __ref_cmp_i2rm_v};//000:add_i2rm_v,101:sub_i2rm_v,111:cmp_i2rm_v,100:and_i2rm_v

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {__ref_add_i2rm_bv, inv, inv, inv, __ref_and_i2rm_bv, sub_i2rm_bv, inv, __ref_cmp_i2rm_bv};//111:cmp_i2rm_bv,101:sub_i2rm_v,100:and_i2rm_bv,000:add_i2rm_bv
...
instr_func group_3_v_entry[8] =
    {__ref_test_i2rm_v, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, inv, idiv_rm2a_v};//111:idiv_rm2a_v,100:mul_rm2a_v,101:imul_rm2a_v,000:test_i2rm_v

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, __ref_call_near_indirect, inv, __ref_jmp_near_indirect, inv, __ref_push_rm_v, inv};//000:inc_rm_v,110:push,001:dec_rm_v,100:jmp_near_ind
