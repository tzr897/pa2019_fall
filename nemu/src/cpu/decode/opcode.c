...
instr_func opcode_entry[256] = {
    ...
    /* 0x54 - 0x57*/ inv, __ref_push_r_v, push_r_v, push_r_v,//55push_r_v,57:push_r_v,56:push_r_v
    ...
    /* 0xe8 - 0xeb*/ call_near, __ref_jmp_near, inv, jmp_short,//e8call_near, e9jmp_near,eb:jmp_short
