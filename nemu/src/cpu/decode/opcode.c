...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_r2rm_b, add_r2rm_v, inv, jmp_near,//10.1700:add_r2rm_b,01add_r2rm_v,02cmps_v,03cmps_v
    ...
    /* 0x18 - 0x1b*/ inv, inv, inv, sbb_rm2r_v,//1b:sbb_rm2r_v
    ...
    /* 0x38 - 0x3b*/ inv, cmp_r2rm_v, cmp_rm2r_b, cmp_rm2r_v,//39:cmp_r2rm_v,3a:cmp_rm2r_b
    ...
    /* 0x54 - 0x57*/ inv, push_r_v, push_r_v, push_r_v,//55push_r_v,57:push_r_v,56:push_r_v
    /* 0x58 - 0x5b*/ inv, inv, inv, pop_r_v,//5b:pop_r_v
    /* 0x5c - 0x5f*/ inv, pop_r_v, pop_r_v, pop_r_v,//5d:pop_r_v,5e:pop_r_v,5f:pop_r_v
    ...
    /* 0xa8 - 0xab*/ test_i2a_b, test_i2a_v, stos_b, inv,//a8:test_i2a_b,a9:test_i2a_v,aa:rep
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_near, ret_near,//c2:ret_near
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, inv, jmp_short,//e8call_near, e9jmp_near,eb:jmp_short
...
instr_func group_1_b_entry[8] =
    {inv, inv, inv, inv, inv, inv, inv, cmp_i2rm_b};//111:cmp_i2rm_b

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, inv, inv, inv, and_i2rm_v, sub_i2rm_v, inv, cmp_i2rm_v};//000:add_i2rm_v,101:sub_i2rm_v,111:cmp_i2rm_v,100:and_i2rm_v

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, inv, inv, inv, and_i2rm_bv, sub_i2rm_bv, inv, cmp_i2rm_bv};//111:cmp_i2rm_bv,101:sub_i2rm_v,100:and_i2rm_bv,000:add_i2rm_bv
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, inv, inv, jmp_near_ind, inv, push_rm_v, inv};//000:inc_rm_v,110:push,001:dec_rm_v,100:jmp_near_ind
